<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{URL::to('assets/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
  ...
  <link href="{{URL::to('assets/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700')}}" rel="stylesheet">
</head>