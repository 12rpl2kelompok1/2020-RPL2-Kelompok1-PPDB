				...
				<div class="card-body">
                    ...
                    <form method="post">
						...
						<div class="form-group row">
                            <label for="student_name" class="col-md-4 col-form-label text-md-right">{{ __('Nama Siswa') }}</label>
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" type="text" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{$siswa->date_of_birth }}" required autocomplete="date_of_birth" autofocus>
